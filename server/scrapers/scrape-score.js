...
async function extractedEvaluateCall(page) {
  ...
  return page.evaluate(() => {
    ...
    let time = null;
    let awayScore;
    if (!document.querySelectorAll(".kno-fb-ctx")[6].innerText) {
      homeTeam = document.querySelectorAll(".kno-fb-ctx")[3].firstChild.innerText;
      // let homeScore = document.querySelectorAll(".imso_mh__l-tm-sc")[0].innerText;
      homeScore = null

      awayTeam = document.querySelectorAll(".kno-fb-ctx")[5].innerText;
      // let awayScore = document.querySelectorAll(".imso_mh__r-tm-sc")[0].innerText;
      time = document.querySelectorAll(".imso_mh__lr-dt-ds")[0].innerText;
      awayScore = null;
    } else {
      homeTeam = document.querySelectorAll(".kno-fb-ctx")[3].firstChild.innerText;
      homeScore = document.querySelectorAll(".imso_mh__l-tm-sc")[0].innerText;


      awayTeam = document.querySelectorAll(".kno-fb-ctx")[5].innerText;
      awayScore = document.querySelectorAll(".imso_mh__r-tm-sc")[0].innerText;
